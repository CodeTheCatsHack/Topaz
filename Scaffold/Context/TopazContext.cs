...
//        => optionsBuilder.UseMySql("server=twenkey.ru;port=25010;database=db_topaz;uid=topazuser;pwd=topazpw", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.2.0-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HttpTransmittingMetric>(entity =>
        {
            ...
            entity.Property(e => e.id).HasComment("Показатели качества услуг связи по передаче данных, за исключением услуг связи по передаче данных для целей передачи голосовой информации");
        ...
        modelBuilder.Entity<MessagingMetric>(entity =>
        {
            ...
            entity.Property(e => e.id).HasComment("Идентификатор качества услуг подвижной радиотелефонной связи в части передачи коротких текстовых сообщений");
        ...
        modelBuilder.Entity<VoiceConnectionMetric>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasComment("Идентификатор качества услуг подвижной радиотелефонной связи в части голосового соединения");
            entity.Property(e => e.MeasureId).HasComment("Внешний идентификатор измерения");
